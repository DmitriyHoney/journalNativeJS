/*
  ...
  Mode
  Установив для modeпараметра значение development, productionили none, вы можете включить встроенные оптимизации веб-пакета, соответствующие каждой среде. Значение по умолчанию равно production.
